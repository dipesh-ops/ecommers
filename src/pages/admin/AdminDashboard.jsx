            ...
            <div className="px-5">
                ...
                <div className="mid mb-5">
                    ...
                    <div className=" bg-blue-50 py-5 rounded-xl border border-blue-100">
                        ...
                        {/* text  */}
                        <div className="">
                            <h1 className=" text-center text-lg text-blue-500"><span className=" font-bold">Name :</span> {user?.name}</h1>
                            <h1 className=" text-center text-lg text-blue-500"><span className=" font-bold">Email :</span> {user?.email}</h1>
                            <h1 className=" text-center text-lg text-blue-500"><span className=" font-bold">Date :</span> {user?.date}</h1>
                            <h1 className=" text-center text-lg text-blue-500"><span className=" font-bold">Role :</span> {user?.role}</h1>
                        </div>
                    </div>
                </div>
